...
- Regeneration keeps the previous AI answer visible when a replacement request fails, dropped bubbles retain their new layout position, and wheel input over a selected bubble scrolls its content without zooming the graph.
